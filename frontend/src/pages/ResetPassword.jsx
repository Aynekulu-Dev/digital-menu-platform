    ...
    return (
      <div className="min-h-screen bg-espresso flex items-center justify-center px-5 text-center">
        <div className="max-w-sm">
          <p className="text-paper text-lg mb-2">Missing reset link</p>
          <p className="text-paper/50 text-sm">
            This page needs the link from your password reset email.
          </p>
          <Link to="/forgot-password" className="text-turmeric text-sm mt-4 inline-block">Request a new link</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-espresso flex items-center justify-center px-5 py-12 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display italic text-3xl text-paper">Set a new password</h1>
        </div>
